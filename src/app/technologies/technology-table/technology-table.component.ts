...
import {ClassificationFramework, CriteriaGrouping, CriterionValue} from '../../shared/interfaces/classification';
...
export class TechnologyTableComponent implements OnInit {
  ...
  findValues(criteriaInstances: Map<string, CriterionValue[]>, criterionId: string): CriterionValue[] {
    const result: CriterionValue[] | undefined = criteriaInstances.get(criterionId);
